      ...
      <div className="container mx-auto px-0 md:px-4">
        ...
        <div className="grid xl:grid-cols-4 gap-12 mb-12 pt-10">
          ...
          <div className="flex flex-col pt-8 xl:col-span-2 p-2 md:p-0">
              <h1 className="h1 max-w-max mb-6 text-3xl md:text-4xl xl:text-5xl">Estamos à disposição para ajudá-lo</h1>
              <p className="subtitle max-w-[500px] mb-8 text-base md:text-lg">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      R. dos Guainumbis, 698 - Vila Costa e Silva
                    </p>
                  </div>
                </div>
        ...
        {/* Google Maps */}
          <div className="w-full h-[400px] rounded-xl overflow-hidden shadow-lg">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3675.866239564987!2d-47.06368492499999!3d-22.9024297!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94c8c8b6da255555%3A0x52bfceb1e74b2ccb!2sR.%20dos%20Guainumbis%2C%20698%20-%20Vila%20Costa%20e%20Silva%2C%20Campinas%20-%20SP%2C%2013080-650!5e0!3m2!1spt-BR!2sbr!4v1718123456789!5m2!1spt-BR!2sbr" 
              width="100%" 
              height="100%" 
              style={{ border: 0 }} 
              allowFullScreen="" 
